...
% INFORMATION
%
% This document may be used as a template for SMiP presentations in LaTeX
% Beamer, based on Martin Schnuerch's Markdown template and SMiP's PowerPoint
% template. 
%
% You can further customize the presentation's theme by changing the underlying
% "beamer...themesmipstyle.sty" documents. There is no warranty whatsoever that
% the document has been coded in best/appropriate LaTeX style.
%
...
% ======================================================================
%
% Update: I personalized the template 
%
% I adapted Susanne Frick's template to my own needs and added my avatar and
% some features that I use frequently. All credit goes to her, but if you have
% any questions about my customizations, feel free to contact me:
% bissantz@uni-landau.de
%
% ======================================================================
%
	...
	\begin{frame}{Curriculum Vitae}
		\begin{columns}
			...
			\begin{column}{0.4\textwidth}
				\begin{figure}
				\visible<2,3>{
					\includegraphics[width=4cm]{subfiles/normal.png}
				}
				\visible<3>{
					\includegraphics[width=4cm]{subfiles/paranormal.png}
